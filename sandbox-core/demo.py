    ...
    try:
        ...
        for i, operation in enumerate(operations, 1):
            ...
            if result["success"]:
                ...
                print(f"   ❌ {operation['id']} failed: {result.get('error', 'Unknown error')}")
        ...
        for snapshot in snapshots:
            ...
            print(f"     Created: {snapshot['created_at']}, Size: {snapshot['size_bytes']} bytes")
        ...
        print(f"   Safe operation validation: {'✅ SAFE' if result.is_safe else '❌ UNSAFE'}")
        ...
        print(f"   Unsafe operation validation: {'✅ SAFE' if result.is_safe else '❌ UNSAFE'}")
        print(f"   Risk level: {result.risk_level.value}")
