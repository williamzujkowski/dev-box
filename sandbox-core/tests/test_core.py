...
from sandbox import HealthMonitor
from sandbox import RollbackManager
from sandbox import SafetyValidator
from sandbox import SandboxConfig

# Import main modules
from sandbox import SandboxCore
from sandbox import SandboxInitializer
from sandbox import SandboxState
from sandbox import StateManager
from sandbox import StateTracker
...
def basic_config(temp_workspace):
    ...
    return SandboxConfig(
        ...
        monitoring_config={"collection_interval": 10, "health_check_interval": 30},
    )
