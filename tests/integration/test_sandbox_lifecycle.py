...
class TestSandboxLifecycle:
    ...
    @pytest.mark.slow
    def test_complete_lifecycle_simulation(
        self, test_vm_manager, integration_test_config
    ):
        ...
        provisioning_success = self._simulate_provisioning(
            vm_id, config["provisioning"]
        )
