...
This directory contains specialized swarm coordination agents designed to work
with the claude-code-flow hive-mind system. Each agent implements a different
coordination topology and strategy.
...
2. **Resource Planning**: Ensure adequate compute/memory for coordination
   overhead
...
- **Coordination Failures**: Verify network connectivity and consensus
  thresholds
...
- **Terminal Management**: Agents can spawn and manage multiple terminal
  sessions
...
For implementation details, see individual agent files and the claude-flow
documentation.
